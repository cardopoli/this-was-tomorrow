...
sections:
  - heading: The communities
    people:
      - name: Jude Tisdall
        role: New Ground, OWCH
      - name: Hazel Tilley
        role: Granby Four Streets
      - name: Naomi Cull and Tom Murphy
        role: Two Up Two Down
      - name: Eden, Paul, Maria
        role: LILAC
      - name: Elizabeth Fraser, Andy Plant
        role: Cressingham Gardens
      - name: Jess Steele, Elsa Simmons
        role: Hastings Commons
      - name: Paul Brannigan
        role: Calder Valley CLT
      - name: Nina, Megan, Cameron, Ree and the whole crew
        role: Tinkers Bubble
      - name: Bryn and Anthony
        role: Kitty's Launderette
      - name: Fi Garrard
        role: Kesoberi
      - name: Rob and Sophie
        role: Trevone Quarry
      - name: Emma Nicholls, Simone Kloos-Parris
        role: Whole Again Communities
    text: ''
  - heading: Partners and collaborators
    people:
      - name: Judith Martin
        role: co-author, original This Was Tomorrow
      - name: Simon Vickery
        role: Open City
      - name: Thaddeus Zupančič
        role: Supporter
      - name: David Marques
        role: Devity Studio
    text: ''
